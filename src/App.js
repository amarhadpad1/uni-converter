...
<div className="small">Simple in-browser converters • no login • minimal</div>
</div>
</div>
...
Tip: For best results use plain-text Word/PDF. Complex documents (layout, images) may require server-side conversion.
</div>
</div>
);
}